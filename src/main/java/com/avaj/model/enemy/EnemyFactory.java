...
public class EnemyFactory {
    ...
    public static Enemy createEnemyForHero(Hero hero, String avatarPath, int tier, String heroClass) {
        ...
        if (tier < 3) {
            ...
            enemy.level = Math.max(1, heroLevel - random.nextInt(2)); // Kahramanın seviyesinden 0 veya 1 düşük olabilir
            ...
            enemy.level = heroLevel + random.nextInt(3) + 1; // Kahramandan 1-3 seviye daha güçlü olabilir
